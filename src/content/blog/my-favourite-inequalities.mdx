...
<div style="display: flex; justify-content: flex-end; color: #c4c1b9">
    <p style="font-style: italic; margin-top: 10rem; width: 50%" class="foot-text"> Finished in my dorm room (6008), 
    surrounded by a growing scent of rapidly burning candlesticks. </p>
</div>