...
The `never` type is often useful while building conditionals as it allows us to enforce exhaustiveness 
...
<div style="display: flex; justify-content: flex-end; color: #c4c1b9">
    <p style="font-style: italic; margin-top: 10rem; width: 50%" class="foot-text">Finished in the airport lounge 
    while awaiting the most delayed flight of my life.</p>
</div>