...
Consider a game that awards $$ 7 $$ points and $$ 11 $$ points to the player on the basis of various scenarios. Since, $$ 7 $$
...
for any player playing the game. After $$ 59 $$ points, every point can be represented as a linear combination
of $$ 7 $$ and $$ 11 $$. 
