...
of your spaghetti code, not to mention time. The only way you get to combat your those that stand in your way
is to befriend Git. In this article, I will go over some crucial Git concepts and techniques that I've picked
...
only arise when there are discrepancies between two versions of the same file**. If the main branch does not have
...
extremely versatile and powerful tool that builds on top of a normal rebase and enables us to modify our
commit tree.
...
All commits are set to `pick` as default action for rebase.
...
I hope this helps you feel more comfortable when tackling large codebases. Now go teach someone a thing or two
