...
This product is a familiar sounding quantity known as the Vector-Jacobian-Product ($$ 1 \times n $$).
...
> A JVP is the adjoint of the VJP. So in principle, we can get the forward pass (JVP) by computing
> [two backward passes](https://github.com/renmengye/tensorflow-forward-ad/issues/2). It is
> like computing the adjoint of the adjoint. 
...
library using Andrej Karpathy's [micrograd](https://github.com/karpathy/micrograd) as a reference.
...
- [Lecture 6: Automatic Differentiation - Roger Grosse](https://www.cs.toronto.edu/~rgrosse/courses/csc421_2019/readings/L06%20Automatic%20Differentiation.pdf)
