...
in a human language. They are based on a meticulous system of _nouns_, _verbs_ and _movements_
...
6. `bi` to insert infront of the current word and `ea` to insert behind it. Priceless moves.
...
very minute I've Vim-med and there's just no going back. Remember, it demands a fair bit of practice before you find yourself whizzing
